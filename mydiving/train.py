...
def train(model, train_loader, loss_fn, optimizer, epoch, device, scaler, writer, args):
    ...
    for i, data in enumerate(train_loader):
        ...
        images, labels_x, labels_y = images.to(device), labels_x.to(device), labels_y.to(device)
        ...
        all_labels.append(labels_x.cpu().numpy())
        ...
        all_scores.append(labels_y.cpu().numpy())
        all_pred_scores.append(reg_outputs.cpu().detach().numpy())
